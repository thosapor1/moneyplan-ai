...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      {/* Subtle gradient overlay matching primary */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg">ยินดีต้อนรับกลับมา</p>
          <p className="text-muted-foreground text-sm mt-1">วางแผนการเงินส่วนบุคคลด้วย AI</p>
        </div>
          ...
          <div className="mt-8 pt-6 border-t border-border">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <p className="text-xs text-muted-foreground">วิเคราะห์การเงิน</p>
              </div>
              <div>
                <div className="text-2xl mb-1">💰</div>
                <p className="text-xs text-muted-foreground">ติดตามรายรับจ่าย</p>
              </div>
              <div>
                <div className="text-2xl mb-1">🎯</div>
                <p className="text-xs text-muted-foreground">วางแผนเป้าหมาย</p>
              </div>
            </div>
          </div>
        </div>
